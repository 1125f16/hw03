function graph(scoresArray){
    ...
    for (var word in scoresArray) {
      nodes.push({radius: radius(scoresArray[word]), color: color(word.length), word: word, score: scoresArray[word]});  
    }
